...
{
    /// <summary>
    /// Implement on a ScriptableObject to receive a callback from
    /// <c>CreateScriptableObjectFromTemplateAction</c>
    /// after the SO is cloned from the template and before it is saved as an asset.
    /// </summary>
    /// <remarks>
    /// This interface lives in the Runtime assembly so game-code ScriptableObjects can
    /// implement it
