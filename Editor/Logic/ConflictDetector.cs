...
namespace Kodlon.AssetRouter.Logic
{
    ...
    internal static class ConflictDetector
    {
        ...
        private static readonly string[] FixedSamplePaths =
        {
            ...
            "Assets/SFX_Click.wav",
            "Assets/SFX_Jump.wav",
            "Assets/Mus_Theme.mp3",
            "Assets/Mus_Loop.ogg",
            "Assets/Env_Rock.fbx",
            "Assets/Char_Hero.fbx",
            "Assets/Sprite_Player.png",
            "Assets/Atlas_UI.png"
        };
        ...
        private static bool IsActive(BaseImportRule rule) => rule != null && rule.isEnabled && !string.IsNullOrEmpty(rule.pattern);
