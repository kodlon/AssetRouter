...
namespace Kodlon.AssetRouter.Actions
{
    ...
    /// </summary>
    /// <remarks>
    /// Extend <see cref="AssetImportActionAsset" /> rather than implementing this
    /// interface directly.
    /// The action pipeline calls <see cref="CanRunOn" /> first; <see cref="Execute" />
    /// runs only when it returns true.
    /// Exceptions thrown in <see cref="Execute" /> are caught per-action and logged;
    ...
    public interface IAssetImportAction
    {
        ...
        /// <param name="ctx">
        /// Context with the asset path, matched rule, database, and
        /// logger.
        /// </param>
