...
{
    /// <summary>
    /// Clones a template ScriptableObject via <c>Instantiate</c>, calls
    /// <see cref="IAssetRouterDataSetup.SetupAssetRouter" />
    ...
    {
        /// <summary>
        /// ScriptableObject to clone. All serialized fields are copied to the new
        /// instance.
        /// </summary>
        public ScriptableObject template;

        /// <summary>
        /// Folder where the output .asset is saved. Falls back to the imported
        ...
        /// <summary>
        /// File name for the output asset without extension. <c>{assetName}</c> is
        ...
        /// <summary>
        /// When false, the action is skipped if an asset already exists at the
        /// output path.
        /// </summary>
        public bool overwriteExisting;

        public override bool CanRunOn(Object importedAsset, AssetImportContext ctx) => template != null;
