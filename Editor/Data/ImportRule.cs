...
{
    /// <summary>
    /// Standard import rule. Applies a Unity Preset on import and runs a list of
    /// post-import actions after the asset is moved.
    /// </summary>
    [Serializable]
    public class ImportRule : BaseImportRule
    {
        ...
        /// <summary>
        /// Ordered list of actions that run after the asset is moved to
        /// <see cref="BaseImportRule.targetFolder" />.
