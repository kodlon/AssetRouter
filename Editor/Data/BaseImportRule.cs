...
{
    /// <summary>
    /// Base class for all import rules. Extend this to create rule variants with
    /// additional fields.
    /// </summary>
    [Serializable]
    public abstract class BaseImportRule
    {
        ...
        /// <summary>
        /// Pattern used to match asset file names (or full paths when
        /// <see cref="matchAgainstFullPath" /> is true).
        /// Glob example: <c>T_*_D.png</c>. Regex example: <c>^T_.+_D\.png$</c>.
        /// </summary>
        public string pattern = "";

        /// <summary>
        /// When true, the pattern is matched against the full asset path (e.g.
        /// <c>Assets/Raw/T_Rock.png</c>).
        /// When false, only the file name is matched. Required for path-based patterns
        /// like <c>Assets/**</c>.
        /// </summary>
        public bool matchAgainstFullPath;
        ...
        /// <summary>
        /// When non-empty, the rule only applies to assets that are already inside this
        /// folder.
        /// Useful for routing the same file name differently depending on the source
        /// folder.
        /// </summary>
        ...
        [SerializeField]
        [HideInInspector]
        [FormerlySerializedAs("extensionFilter")]
        internal string _legacyExtensionFilter = "";

        [NonSerialized]
        internal string _compiledFor;

        [NonSerialized]
        internal PatternMode _compiledForMode;

        [NonSerialized]
        internal Regex _compiledPattern;

        [NonSerialized]
        internal int _sessionMatchCount;
    }
}