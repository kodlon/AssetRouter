...
namespace Kodlon.AssetRouter.Data
{
    ...
    /// Create one via <c>Create &gt; Asset Router &gt; Settings Database</c>; the
    /// plugin auto-creates a default at
    ...
    public class ImporterSettingsDatabase : ScriptableObject
    {
        ...
        /// <summary>
        /// Schema version stored in this asset. Migrated automatically on load
        /// when below <see cref="LatestSchemaVersion" />.
        /// </summary>
        public int schemaVersion;

        /// <summary>
        /// When true, the postprocessor routes assets automatically on every
        /// import. Disable to use Dry Run only.
        /// </summary>
        ...
        /// <summary>
        /// Asset paths that Asset Router never processes. Any asset inside a listed folder
        /// is skipped.
