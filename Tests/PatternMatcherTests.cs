...
namespace Kodlon.AssetRouter.Tests
{
    public class PatternMatcherTests
    {
        ...
        {
            var rule = MakeRule(PatternMode.Glob, "Assets/**", true);
        ...
        {
            var rule = MakeRule(PatternMode.Glob, "Assets/**/T_*.png", true);
        ...
        {
            var rule = MakeRule(PatternMode.Glob, "T_*", false);
        ...
        {
            var rule = MakeRule(PatternMode.Glob, "Assets/Sub/*", true);
            Assert.IsTrue(PatternMatcher.Matches(rule, "Assets/Sub/T_Rock.png"));
        ...
        private static ImportRule MakeRule(PatternMode mode, string pattern, bool matchFullPath = false) =>
            new()
            {
                patternMode = mode,
                pattern = pattern,
                matchAgainstFullPath = matchFullPath,
                isEnabled = true
            };
    }
}